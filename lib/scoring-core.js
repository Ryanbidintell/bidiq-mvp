...
function scoreOpportunity(opp, profile) {
    ...
    if (active.length) {
        ...
        index = clamp(Math.round(index + keywordModifier(opp.goodCount, opp.badCount)), 0, 100);
    }
    ...
    return {
        ...
        buckets,
        modifiers: { keyword: keywordModifier(opp.goodCount, opp.badCount) },
        alerts,
    };
}

if (typeof module !== 'undefined' && module.exports) {
    module.exports = { scoreOpportunity, scoreProjectFit, scoreScopeFit, scoreClientFit, keywordModifier, computeCompleteness, recommend, BUILDING_TYPES, ABSTAIN };
}
